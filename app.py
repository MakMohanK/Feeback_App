            ...
            if connection:
                try:
                    with connection.cursor() as cursor:
                        sql = """
                        INSERT INTO feedback (first_name, last_name, username, email, phone, comments, rating)
                        VALUES (%s, %s, %s, %s, %s, %s, %s)
                        """
                        cursor.execute(sql, (first_name, last_name, username, email, phone, comments, rating))
                    connection.commit()
...
def feedback_list():
    try:
        ...
        if connection:
            try:
                with connection.cursor() as cursor:
                    sql = "SELECT first_name, last_name, username, email, comments, rating FROM feedback"
                    cursor.execute(sql)
